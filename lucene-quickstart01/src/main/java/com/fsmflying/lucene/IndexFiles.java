...
//        }
        ...
        docsPath = "D:\\dev\\lucene\\lucene-7.3.1\\docs";
        indexPath = "D:\\dev\\gitRepositoryBase\\quickstart\\lucene-quickstart01\\target\\index";
    ...
    static void indexDoc(IndexWriter writer, Path file, long lastModified) throws IOException {
        try (InputStream stream = Files.newInputStream(file)) {
            ...
            // 将文件的路径添加为名为“path”的字段。 使用索引（即可搜索）的字段，但不要将字段标记为单独的字，
            // 也不要索引术语频率或位置信息：
